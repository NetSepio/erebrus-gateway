...
var activityActions = map[string]string{
	...
	"POST /api/v2/subscriptions/trial":                               "subscription.trial_retired",
	"POST /api/v2/subscriptions/nft/refresh":                         "subscription.nft_verify",
	"POST /api/v2/orgs":                                              "org.create",
	"PATCH /api/v2/orgs/:id":                                         "org.update",
	"PATCH /api/v2/orgs/:id/profile":                                 "org.profile.update",
	"PATCH /api/v2/orgs/:id/profile/public":                          "org.profile.public.update",
	"POST /api/v2/orgs/:id/members":                                  "org.member.add",
	"POST /api/v2/orgs/:id/members/invite":                           "org.member.invite",
	"PATCH /api/v2/orgs/:id/members/:memberId":                       "org.member.update",
	"DELETE /api/v2/orgs/:id/members/:memberId":                      "org.member.remove",
	"POST /api/v2/orgs/:id/seats/assign":                             "org.seat.assign",
	"POST /api/v2/orgs/:id/seats/revoke":                             "org.seat.revoke",
	"POST /api/v2/orgs/:id/node-registration-tokens":                 "org.registration_token.create",
	"POST /api/v2/orgs/:id/nodes/register":                           "org.node.register",
	"PATCH /api/v2/orgs/:id/nodes/:nodeId":                           "org.node.update",
	"POST /api/v2/orgs/:id/nodes/:nodeId/services":                   "org.service.attach",
	"PATCH /api/v2/orgs/:id/nodes/:nodeId/services/:serviceId":       "org.service.update",
	"DELETE /api/v2/orgs/:id/nodes/:nodeId/services/:serviceId":      "org.service.detach",
	"POST /api/v2/orgs/:id/nodes/:nodeId/firewall/restart":           "org.firewall.restart",
	"POST /api/v2/orgs/:id/nodes/:nodeId/firewall/sync":              "org.firewall.sync",
	"POST /api/v2/orgs/:id/nodes/:nodeId/firewall/reset-credentials": "org.firewall.reset_credentials",
	"POST /api/v2/orgs/:id/nodes/:nodeId/firewall/rules":             "org.firewall.rule.create",
	"PATCH /api/v2/orgs/:id/nodes/:nodeId/firewall/rules/:ruleId":    "org.firewall.rule.update",
	...
	"POST /api/v2/drop/uploads":                                      "drop.upload.reserve",
	"PUT /api/v2/drop/uploads/:uploadId/content":                     "drop.upload",
	"PATCH /api/v2/drop/files/:fileId":                               "drop.visibility.change",
	"DELETE /api/v2/drop/files/:fileId":                              "drop.delete",
	"POST /api/v2/orgs/:id/nodes/:nodeId/drop/webui/session":         "drop.webui.session",
	"POST /api/v2/admin/perks":                                       "admin.perk.upsert",
	"POST /api/v2/admin/perks/:id/grant":                             "admin.perk.grant",
	"PATCH /api/v2/admin/settings":                                   "admin.settings.update",
}
